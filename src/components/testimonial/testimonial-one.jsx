...
const testimonialData = [
  {
    ...
    desc: "He nicked it fantastic well on your bike mate have it  a I bum bag I twit easy peasy that, chimney pot amongst are you taking the piss daft show off show off pick.",
  },
  {
    id: 2,
                ...
                {testimonialData.map((testimonial) => {
                  return (
                    <div key={testimonial.id} className="testimonial__item">
                      <p className="white-color">{testimonial.desc}</p>
