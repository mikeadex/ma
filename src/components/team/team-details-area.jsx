            ...
            <div className="row">
               <div className="col-xl-10 offset-xl-1">
                  <div className="team__details-info mt-60">
                     ...
                     <p >So I said on your bike mate easy peasy dropped a clanger blow off porkies is fantastic show off show off pick your nose and blow off, faff about bubble and squeak bugger all mate happy days hotpot do not get shirty with me jolly good gormless barmy.</p>

                     <NavLink to="/contact" className="z-btn mt-10">Appionment</NavLink>
                  </div>
               </div>
            </div>
         </div>
