                     ...
                     <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        <div className="footer__widget mb-45 wow fadeInUp" data-wow-delay=".2s">
                           ...
                           <div className="footer__widget-content footer__widget-content-2">
                              <p className="mb-30">Copyright © {new Date().getFullYear()} All Rights Reserved passion by Theme_Pure</p>
                  ...
                  <div className="row align-items-center">
                     <div className="col-xl-12 text-center">
                        <div className="footer__copyright-text footer__copyright-text-2">
                           <p>Copyright © {new Date().getFullYear()} All Rights Reserved passion by <NavLink to="/">Theme_Pure</NavLink></p>
                        </div>
                     </div>
                  </div>
               </div>
